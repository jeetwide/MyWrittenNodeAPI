...
public class CustomDialogClass extends Dialog implements View.OnClickListener {
    ...
    public CustomDialogClass(@NonNull Context context, AddDataInterface addDataInterface) {
        super(context);
...
/*
        ...
        yes.setOnClickListener(CustomDialogClass.this);
        no.setOnClickListener(CustomDialogClass.this);
    }
